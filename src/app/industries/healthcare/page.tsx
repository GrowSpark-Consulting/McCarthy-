...
import { HEALTHCARE_CONTENT } from '@/content/industries/healthcare';
import { siteConfig } from '@/lib/site-config';

const C = HEALTHCARE_CONTENT;
 ...
 *
 * Content is transcribed verbatim from the supplied `healthcare.html` brief
 * (see `content/industries/healthcare.ts`); composition follows the same
