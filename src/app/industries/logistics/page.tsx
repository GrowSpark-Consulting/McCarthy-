...
import { LOGISTICS_CONTENT } from '@/content/industries/logistics';
import { siteConfig } from '@/lib/site-config';

const C = LOGISTICS_CONTENT;
 ...
 *
 * Content is transcribed verbatim from the supplied `logistics.html` brief
 * (see `content/industries/logistics.ts`); composition follows the same
 * industry-page structure as the rest of the Industries family. This is the
 * largest catalogue yet at five capability categories / 15 agents.
 */
