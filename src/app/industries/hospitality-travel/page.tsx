...
import { HOSPITALITY_TRAVEL_CONTENT } from '@/content/industries/hospitality-travel';
import { siteConfig } from '@/lib/site-config';

const C = HOSPITALITY_TRAVEL_CONTENT;
 ...
 *
 * Content is transcribed verbatim from the supplied `hospitality-travel.html`
 * brief (see `content/industries/hospitality-travel.ts`); composition
 * follows the same industry-page structure as Education and Manufacturing.
 */
