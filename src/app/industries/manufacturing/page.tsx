...
import { MANUFACTURING_CONTENT } from '@/content/industries/manufacturing';
import { siteConfig } from '@/lib/site-config';

const C = MANUFACTURING_CONTENT;
 ...
 * `manufacturing-mockup-full.html` brief (see
 * `content/industries/manufacturing.ts`), including all seven capability
 * categories — composition follows the same industry-page structure as
 * Education and Hospitality & Travel.
 */
