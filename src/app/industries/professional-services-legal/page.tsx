...
import { PROFESSIONAL_SERVICES_LEGAL_CONTENT } from '@/content/industries/professional-services-legal';
import { siteConfig } from '@/lib/site-config';

const C = PROFESSIONAL_SERVICES_LEGAL_CONTENT;
 ...
 * `professional-services-legal.html` brief (see
 * `content/industries/professional-services-legal.ts`); composition follows
 * the same industry-page structure as Education, Hospitality & Travel and
 * Manufacturing.
 */
export default function ProfessionalServicesLegalPage() {
  return (
    <>
