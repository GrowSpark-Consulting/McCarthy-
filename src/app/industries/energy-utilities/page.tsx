...
import { ENERGY_UTILITIES_CONTENT } from '@/content/industries/energy-utilities';
import { siteConfig } from '@/lib/site-config';

const C = ENERGY_UTILITIES_CONTENT;
 ...
 *
 * Content is transcribed verbatim from the supplied `energy-utilities.html`
 * brief (see `content/industries/energy-utilities.ts`); composition follows
