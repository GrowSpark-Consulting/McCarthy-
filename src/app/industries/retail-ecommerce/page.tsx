...
import { RETAIL_ECOMMERCE_CONTENT } from '@/content/industries/retail-ecommerce';
import { siteConfig } from '@/lib/site-config';

const C = RETAIL_ECOMMERCE_CONTENT;
 ...
 *
 * Content is transcribed verbatim from the supplied `retail-ecommerce.html`
 * brief (see `content/industries/retail-ecommerce.ts`); composition follows
 * the same industry-page structure as the rest of the Industries family.
 */
