...
import { CONSTRUCTION_CONTENT } from '@/content/industries/construction';
 ...
 *
 * Content is transcribed verbatim from the supplied `construction.html`
 * brief (see `content/industries/construction.ts`); composition follows the
