...
import { FINANCIAL_SERVICES_CONTENT } from '@/content/industries/financial-services';
import { siteConfig } from '@/lib/site-config';

const C = FINANCIAL_SERVICES_CONTENT;
 ...
 *
 * Content is transcribed verbatim from the supplied `financial-services.html`
 * brief (see `content/industries/financial-services.ts`); composition
 * follows the same industry-page structure as the rest of the Industries
 * family.
 */
