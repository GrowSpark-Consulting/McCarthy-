...
import { GOVERNMENT_PUBLIC_SECTOR_CONTENT } from '@/content/industries/government-public-sector';
import { siteConfig } from '@/lib/site-config';

const C = GOVERNMENT_PUBLIC_SECTOR_CONTENT;
 ...
 *
 * Content is transcribed verbatim from the supplied
 * `government-public-sector.html` brief (see
 * `content/industries/government-public-sector.ts`); composition follows the
 * same industry-page structure as the rest of the Industries family.
 */
