...
import { EDUCATION_CONTENT } from '@/content/industries/education';
import { siteConfig } from '@/lib/site-config';

const C = EDUCATION_CONTENT;
 ...
 *
 * Content is transcribed verbatim from the supplied `education.html` brief
 * (see `content/industries/education.ts`); composition follows the Kyndryl
 * industry-page reference's structure using McCarthy's own design system —
 * local nav → dark hero → overview → why now → capability catalogue →
 * business case → resources → how we work → expert Q&A → customer success →
 * FAQ → trends → CTA → footer.
 */
  ...
  return (
    <>
      <div className="relative pb-16 lg:pb-24">
        ...
        <IndustryHero content={C.hero} imageSrc="/videos/hero-ai-office-poster.jpg" />
